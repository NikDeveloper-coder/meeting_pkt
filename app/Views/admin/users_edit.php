    ...
    <section class="d-flex flex-column gap-3">
      <div class="page-head">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
          <div>
            <h3 class="mb-0"><i class="bi bi-person-gear text-info me-2"></i>Edit User</h3>
            <div class="text-muted">Update user information and permissions</div>
          </div>
      ...
      <div class="form-card">
        ...
        <form method="POST" action="<?= site_url('admin/users/update/' . $user['user_Id']) ?>">
          <div class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="username" name="username" 
                     value="<?= old('username', $user['user_Category'] ?? '') ?>" required>
            </div>
              ...
              <select class="form-select" id="jabatan_id" name="jabatan_id" required>
                ...
                <?php foreach($jabatan_list as $jabatan): ?>
                  <option value="<?= $jabatan['jabatan_name'] ?>" 
                    <?= (old('jabatan_id', $user['jabatan_id'] ?? '') == $jabatan['jabatan_name']) ? 'selected' : '' ?>>
            ...
            <div class="col-md-6">
              ...
              <select class="form-select" id="category" name="category" required>
                <option value="user" <?= (old('category', $user['Category'] ?? '') == 'user') ? 'selected' : '' ?>>User</option>
                <option value="admin" <?= (old('category', $user['Category'] ?? '') == 'admin') ? 'selected' : '' ?>>Admin</option>
              </select>
            </div>
